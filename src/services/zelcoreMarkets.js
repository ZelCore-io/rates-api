...
var zelcoreMarkets = {
  getAll() {
    return Promise.all([
      ...
      apiRequest(`https://min-api.cryptocompare.com/data/pricemultifull?fsyms=QTUM,XEM,ONGAS,ONT,MIOTA,GAS,TRX,DGB,XLM,DOGE,EOS,ADA,XRP,DOCK,NEO,BTT,GRS,XCASH,LEO,USDS,ENQ,FTM,0XBTC,AERGO,UBT,ILC,HEX,COMP,VIDT,DRGN,WBTC,OM,COIN,UNI&tsyms=BTC&api_key=${apiKey}`), // 2
