...
var zelcoreMarkets = {
  getAll() {
    return Promise.all([
      ...
      apiRequest(`https://min-api.cryptocompare.com/data/pricemultifull?fsyms=MER,ALEPH,FLUX,ER,QTUM,XEM,ONGAS,ONT,MIOTA,GAS,TRX,DGB,XLM,DOGE,EOS,ADA,XRP,DOCK,NEO,BTT,GRS,XCASH,LEO,USDS,ENQ,FTM,0XBTC,AERGO,UBT,ILC,HEX,COMP,VIDT,DRGN,WBTC,OM,UNI,JST,BDX,FIRO,CAKE,MATIC,ZCL,VBK&tsyms=BTC&api_key=${apiKey}`), // 2
