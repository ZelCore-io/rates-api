...
export const coinAggregatorIDs = {
  ...
  coingecko: [...new Set([
    ...
    'band-protocol', 'storm', 'cartesi', 'nkn', 'quick', 'woo-network', 'polycat-finance', 'stratis', 'energy-web-token', 'prometeus', 'coti', 'orchid-protocol', 'tomochain', 'orbs', 'ultra', 'badger-dao', 'pha', 'ethos', 'ethos-3',
