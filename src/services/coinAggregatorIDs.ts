...
export const coinAggregatorIDs = {
  ...
  coingecko: [... new Set([
    ...
    'band-protocol', 'storm', 'cartesi', 'nkn', 'quick', 'woo-network', 'polycat-finance', 'stratis', 'energy-web-token', 'prometeus', 'coti', 'orchid-protocol', 'tomochain', 'orbs', 'ultra', 'badger-dao', 'pha', 'smooth-love-potion',
    ...
    'kurobi', 'frax', 'fio-protocol', 'avalanche-2', 'terra-luna', 'safemoon-2', 'bittorrent', 'elrond-erd-2', 'zero', 'sonm', 'ergo', 'kdlaunch', 'kaddex', 'kdswap', 'algorand', 'kaspa', 'planetwatch', 'xfinite-entertainment-token', 'opulous',
