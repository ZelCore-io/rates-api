...
var zelcoreRates = {
  getAll() {
    return Promise.all([
      ...
      apiRequest('https://min-api.cryptocompare.com/data/pricemulti?fsyms=ONGAS,ONT,MIOTA,GAS,TRX,DGB,XLM,DOGE,EOS,ADA,XRP,DOCK,NEO,TRON,BTT,SAFE,BTH,GRS,XCASH,LEO,USDS&tsyms=BTC'),  //  3
